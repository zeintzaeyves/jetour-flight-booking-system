            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
              <div>
                ...
                <p className="mt-6 max-w-2xl text-base leading-8 text-white/50 md:text-lg">
                  Review route details, fare inclusions, baggage allowance, and
                  flight schedule before continuing your booking.
                </p>
              </div>

              <div className="rounded-[2rem] border border-white/10 bg-black/25 p-3 shadow-2xl shadow-black/20 backdrop-blur-2xl lg:min-w-[460px]">
